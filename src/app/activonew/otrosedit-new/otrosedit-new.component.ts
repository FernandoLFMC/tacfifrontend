...
@Component({
  selector: 'app-otrosedit-new',
  templateUrl: './otrosedit-new.component.html',
  styleUrls: ['./otrosedit-new.component.css']
})
export class OtroseditNewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('edit otros', id)

      this.activoservice.getidacti(id)
      .subscribe(
        res=>{console.log('res get id', res)
              ...
              const id=res.id_cuenta
              if (id=="177"){
                this.titulo="Obras de arte"
              }else{ if (id=="178"){
                  this.titulo="Vienes tomados en arrendamiento"
                }else{if (id=="179"){
                    this.titulo="Obras de construccion" 
                  }else{if (id=="180"){
                      this.titulo="Otros activos"
                    }else{if (id=="181"){
                        this.titulo="Bienes diversos"
                      }else{if (id=="182"){
                          this.titulo="Cargos diferidos"
                        }else{if (id=="183"){
                            this.titulo="Partidas pendientes de imputacion"
                          }else{if (id=="184"){
                              this.titulo="Activos intangibles"
                            }
                          }
                        }
                      }
